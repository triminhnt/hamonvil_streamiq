...
**Expected output:**
```
Telegram notification sent for Stop event in project claudesuperkit-engineer
```
...
📁 Project: claudesuperkit-engineer
🔧 Total Operations: 15
🆔 Session: abc12345...
...
📍 Location: `/Users/user/projects/claudesuperkit-engineer`
```
